      ...
      <div className="politique-content">
          ...
          <div className="politique-info">
            ...
            <ul>
              <li>
                ...
                navigateur, système d&apos;exploitation, pages visitées, durée
                de visite
              </li>
              <li>
        ...
        <section className="politique-section" aria-labelledby="duree">
          ...
          <div className="politique-info">
            <ul>
              ...
              <li>
                <strong>Comptes administrateurs :</strong> Jusqu&apos;à
        ...
        <section className="politique-section" aria-labelledby="dest">
          ...
          <div className="politique-info">
            ...
            <ul>
              <li>
                <strong>L&apos;équipe de L&apos;Iconodule :</strong> Gestion du
        ...
        <section className="politique-section" aria-labelledby="transferts">
          ...
          <div className="politique-info">
            <p>
              ...
              et ne font l&apos;objet d&apos;aucun transfert vers des pays
              tiers.
            </p>
            <p>
        ...
        <section className="politique-section" aria-labelledby="droits">
          ...
          <div className="politique-info">
            ...
            <p>
              Vous pouvez demander l&apos;accès à toutes vos données
        ...
        <section className="politique-section" aria-labelledby="mineurs">
          ...
          <div className="politique-info">
            <p>
              Notre site s&apos;adresse à un public majeur. Nous ne collectons
              pas sciemment de données personnelles concernant des mineurs de
              moins de 16 ans.
            </p>
            <p>

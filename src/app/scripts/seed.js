...
const roomsData = [
    ...
    artworks: [
      {
        ...
        description: "Une œuvre expérimentale inspirée du constructivisme. Cette pièce explore les limites entre forme et fonction.",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description: "Exploration brute de la fragmentation visuelle. L'artiste déconstruit les conventions artistiques traditionnelles.",
        createdAt: new Date(),
        updatedAt: new Date()
      }
    ]
  ...
  },
  {
    ...
    description: "Passage vers les autres espaces",
    coordinates: {
      top: "21%",
      left: "20%",
      width: "3%",
